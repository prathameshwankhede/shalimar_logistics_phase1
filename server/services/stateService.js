...
export async function getRateSubmissions(user) {
  ...
  return rows.map(b => ({
    ...
    rate_per_unit: Number(b.rate_per_mt || 0),
    rate_per_mt: Number(b.rate_per_mt || 0),
    quoted_quantity_mt: Number(b.quoted_quantity_mt || 0),
    total_amount: Number(b.total_amount || 0),
    bid_status: b.bid_status || 'Submitted',
    status: b.bid_status || 'Submitted',
    negotiation_status: b.bid_status || 'Submitted',
    original_rate: Number(b.original_rate || b.rate_per_mt || 0),
    counter_offer_rate: b.counter_offer_rate ? Number(b.counter_offer_rate) : null,
    counter_rate: b.counter_offer_rate ? Number(b.counter_offer_rate) : null,
    counter_offer_status: b.counter_offer_status || null,
    counter_offer_by: b.counter_offer_by || null,
    final_rate: b.final_rate ? Number(b.final_rate) : (b.finalized_rate ? Number(b.finalized_rate) : null),
    finalized_rate: b.finalized_rate ? Number(b.finalized_rate) : (b.final_rate ? Number(b.final_rate) : null),
    finalized_by: b.finalized_by || null,
    is_finalized: b.is_finalized === 1 || b.is_finalized === true || ['FINALIZED', 'COUNTER_ACCEPTED'].includes(String(b.bid_status || '').toUpperCase()) || Boolean(Number(b.final_rate) > 0),
    acceptance_status: b.acceptance_status || (b.is_finalized ? 'PENDING' : null),
    transporter_accepted_at: b.transporter_accepted_at || null,
    transporter_accepted_by: b.transporter_accepted_by || null,
